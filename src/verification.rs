...
async fn run_check(check: &Check, input: Option<&str>, ast_cache: &mut AstCache) -> RawResult {
    match &check.check_type {
        ...
        CheckType::TypescriptTypeCheck {
            ...
            check_typescript_type_check(paths, working_dir.as_deref(), *timeout_secs).await
        }
        ...
        CheckType::CssHtmlConsistency {
            ...
            css_path,
            working_dir,
        } => check_css_html_consistency(html_path, css_path, working_dir.as_deref()),
    }
}
...
async fn check_typescript_type_check(
    paths: &[String],
    working_dir: Option<&str>,
    timeout_secs: u64,
) -> RawResult {
...
async fn check_jest_vitest_result(
    test_path: &str,
    min_passed: Option<usize>,
    max_failures: Option<usize>,
    max_skipped: Option<usize>,
